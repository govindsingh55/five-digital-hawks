...
<SEO
  ...
  description="Case studies of high-performance lifecycle and retention marketing campaigns for global brands."
  keywords={[
    "marketing case studies",
    "retention marketing results",
...
<!-- Page Hero -->
<section
  class="relative pt-32 pb-20 bg-linear-to-br from-brand-accent via-brand-accent/80 to-brand-primary/60 text-white overflow-hidden"
>
  ...
  <div class="container mx-auto px-4 max-w-5xl relative z-10 text-center">
    ...
    >
      Real results for ambitious brands. We don't just build systems; we build
      revenue engines.
    </p>
  </div>
</section>
      ...
      {#each filteredProjects as project, i (project.title)}
        ...
        >
          ...
          <figure class="relative h-48 sm:h-52 overflow-hidden">
            ...
            />
            <div
              class="absolute inset-0 bg-linear-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4"
            >
          ...
          >
            ...
            >
              <div class="flex items-center gap-2">
                <TrendingUp size={18} class="text-brand-accent shrink-0" />
                <span class="text-sm font-bold text-brand-primary">Result</span>
              </div>
