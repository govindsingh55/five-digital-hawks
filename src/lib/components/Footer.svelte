...
>
  <div class="container mx-auto px-4 max-w-7xl">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
      ...
      <div class="lg:col-span-1">
        ...
        <p class="text-base-content/70 leading-relaxed mb-6">
          Architecting predictable, scalable, and highly profitable marketing
          systems for visionary brands since 2011.
        </p>
      ...
      <div>
        ...
        <ul class="flex flex-col gap-4">
          <li class="flex items-start gap-3 text-base-content/70">
            <MapPin size={20} class="text-brand-accent mt-1 shrink-0" />
            <span>7 Dalkeith court, Fitzgibbon,<br />Australia, 4018</span>
          </li>
    ...
    >
      <p>
        &copy; {new Date().getFullYear()} Five Digital Hawks. All rights reserved.
      </p>
      <div class="flex gap-4">
